  ...
  <div class="container">
    ...
    <div class="description">
      ...
      <div class="column2">
        ...
        <p>{!! $show->summary !!} <a href="#">read more</a></p>
    ...
    <Form method="POST" action="{{ route('reviews.store') }}">
             @csrf
            <input type="text" placeholder="Que te pareció?..." class="form-control" name="content" autocomplete="off" >
            <input type="hidden" value="{{$show->id}}" name="movie_id">
            <!-- <input type="Submit" value="Carga mi reseña!"> -->
            <button type="Submit" class="btn btn-primary" >Carga mis reseña!</button>
        </Form>
        <div class="row">
            <div class="col">
                <h3>Reseñas</h3>
                ...
                <label class="label-info">{{ $review->content }} dfd</label>
